...
- High level concepts and potential classes that could be found in the SPARQL endpoints and used to answer the question. They are not necessary in the question, but if you think they are relevant to answer the question, you can include them.
- Potential entities and instances of classes that could be found in the SPARQL endpoints and used to answer the question. They are not necessary in the question, but if you think they are relevant to answer the question, you can include them.
